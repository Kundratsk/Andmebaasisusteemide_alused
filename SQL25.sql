...
--1. PROCEDURE + IF ELSE
--Kontrollib kas töötaja eksisteerib
...
END
--3. PROCEDURE + COUNT
--Loeb mitu töötajat manageril on
...
--Tagasta töötajate arv OUTPUT kaudu
...
--Salvesta manageri töötajad temp tabelisse
...
--View näide
--Näita töötajaid ja nende juhte
...
-- Stored procedure näide
--Otsi töötajat ID järgi
...
--Tagastab töötajad konkreetse manageri järgi.
...
--Temp table näited
--Salvesta töötajad temp tabelisse
...
--teeb nime järgi otsingu kiiremaks
